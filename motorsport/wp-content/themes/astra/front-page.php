...
<main>
  <div class="container">
    ...
    <section class="blogs" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/blog.jpg');">
      ...
      <div class="blog-row">
        <div class="blog-card">
          <a href="<?php echo get_permalink(200); ?>">Title 1</a>
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/blogs/title1.jpg" alt="Logo"> </div>
        <div class="blog-card">Blog 2</div>
        <div class="blog-card">Blog 3</div>
      </div>
      <a href="<?php echo get_permalink( get_page_by_path('blogs') ); ?>" class="btn-show-more">Show More</a>
    </section>
